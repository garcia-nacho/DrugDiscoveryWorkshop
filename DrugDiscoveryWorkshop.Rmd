...
By standardizing the data we force the mean of the data to be 0 and the standard deviation to be 1 (aka as Z score). 
...
To know how well the model generalizes, we use a validation set. The model has never *seen* the SMILES from the validation set. The better the model performs in the validation set, the better it is.
