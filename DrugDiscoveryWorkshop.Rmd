...
We check and load the files in the pathDB one by one. Once the file is processed it is not going to be processed anymore. By adding the name of the file to the db.completed folder. In this way the model never stops while there are files to process. 